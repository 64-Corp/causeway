 ...
 * @constructor
 */
module.exports = Causeway = function () {
    this._connections = {};
    self = this;
};
...
/**
 * @method register
 * @param {Object} JSON containing string keys for addr, port and auth
...
Causeway.prototype.register = function (config) {
    // loop through profiles and setup redis clients
 ...
 *          casueway.using('coffee_barista').request('more coffee', { take: { my: 'money' } });
 */
